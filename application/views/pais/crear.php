...
<section class="content-header">
      <h1>
        <i class="fas fa-globe"></i>&nbsp;&nbsp;Registro de países
      </h1>
    </section>
	<section class="content">
<div id="creator">
	<form id="idFormulario" onchange="permitirEnvio();" name="idFormulario" action="<?= base_url()?>pais/crearPost" method="post" >
		<fieldset>
			...
			<div class="nav navbar-form navbar-right">
				...
				<input type="button" class="btn btn-default" id="idRegistro" name="registrarse" value="Registrar país" onclick="validar();" />
			</div>
