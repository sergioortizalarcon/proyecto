...
<div id="creator">
	<form id="idFormulario" onchange="permitirEnvio();" name="idFormulario" action="<?= base_url()?>idioma/crearPost" method="post" >
		<fieldset>
			...
			<div class="nav navbar-form navbar-right">
				...
				<input type="button" class="btn btn-default" id="idRegistro" name="registrarse" value="Registrar idioma" onclick="validar();" />
			</div>
