...
<div class="content-wrapper">
	...
	<section class="content">
		<div id="creator">
			<form id="idFormulario" onchange="permitirEnvio();" name="idFormulario" action="<?= base_url()?>pais/editarPost" method="post">
				<fieldset>
					<legend><?= $body['paises']->nombre ?></legend>
					...
					<div class="form-group">
						...
						value="<?= $body['paises']->nombre ?>" data-toogle="tooltip" data-placement="left" title="Escribe un nombre" />
